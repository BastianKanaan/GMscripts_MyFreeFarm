...
try{
    ...
    var help;
    openWindows="";
    if(DEVMODE_FUNCTION){ GM_logInfo("checkOpenWindow","justcheck="+justcheck,"automatStarted="+automatStarted+" busy="+bot.isBusy()+" closeWindowTimer="+closeWindowTimer,"Begin"); }
...
logBubble.add("autoMegafield: PRODSTOP");
                ...
                var i=0;
                loop:
                for(var r=1;r<=unsafeData.BUILDING_SIZE["megafield"][1];r++){
                    for(var c=1;c<=unsafeData.BUILDING_SIZE["megafield"][0];c++){
                ...
                if(actionField){
logBubble.add("autoMegafield: plant on "+String.fromCharCode(64+actionField[0])+actionField[1]);
