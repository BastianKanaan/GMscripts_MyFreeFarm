...
const neededVersionBerater="2.3.7";
...
const CHANGELOG=[["2.0","29.05.2014",[["Migration nach openuserjs.org","Migration to openuserjs.org"],["Script wird jetzt auf GitHub entwickelt","Script now developed on GitHub"]]],
				 ...
				 ["2.1.6","11.12.2014",[["Neues Feature: Waltraud-Bot kann jetzt in den Optionen aktiviert werden","New feature: Bot for donkey can be activated in options"]]]
				];
...
function autoDonkey(runId) {
	try {
		if (bot.checkRun("autoDonkey", runId)) {
			top.unsafeData.autoAction = "automat: autoDonkey";
			busy_action = "autoDonkey";

			// Add listing for donkey response event
			document.addEventListener("gameDonkeyResponse", function () {
				document.removeEventListener("gameDonkeyResponse", arguments.callee, false);
