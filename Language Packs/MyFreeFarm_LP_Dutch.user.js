// ==UserScript==
// @name        MyFreeFarm LP Dutch
// @namespace   https://github.com/BastianKanaan/GMscripts_MyFreeFarm
// @author      BastianKanaan
// @description Language pack "Dutch" for MyFreeFarm Scripts
// @date        02.09.2015
// @version     1.0.4
...
// Do not edit ********************************************************************************************************
    ...
    // Important constants
    const COUNTRY="NL"; // The country ISO-code (2 digits)
    const LANGUAGE="nl"; // The language ISO-code (2 digits)        
...
// Take the following from the game ***********************************************************************************
    if(undefined===text[LANGUAGE]){
        ...
        text[LANGUAGE]["msgSubjectMarketsale"]="Marktplaats";
        // - The content: The text where the information is stated. The information has to be replaced by "(.+?)".
        text[LANGUAGE]["msgContentMarketsale"]="(.*) heeft op de marktplaats\\s*(\\d+)\\s*x\\s*(.*?) van jou gekocht voor (.*?)\\s*aD\\."; 
        // *************
        // Take from a message sent if you sell something via contract.
        // - The subject.
        text[LANGUAGE]["msgSubjectContractsale"]="Een contract is geaccepteerd";
        // - The content: The text where the general information is stated. The information has to be replaced by "(.+?)".
        text[LANGUAGE]["msgContentContractsale"]="(.*) heeft een contract geaccepteerd!<br><br>\\s*De volgende producten zijn verkocht:<br>([\\S\\s]*)\\s*<br>\\s*Het bedrag (.*?) aD is bijgeschreven op je rekening\\."; 
        ...
        // *************
        // Take the subject from a message sent if you buy coins
        ...
        // Take the subject from a message sent if you completed a quest.
